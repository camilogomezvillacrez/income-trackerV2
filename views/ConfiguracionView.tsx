...
import MediosPagoPanel from "@/components/settings/MediosPagoPanel";
...
/** Encabezado de sección: agrupa los paneles para no leerlos como una lista larga. */
function Section({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <section style={{ marginBottom: "22px" }}>
      <h3 style={{ fontSize: "10.5px", fontWeight: 700, color: "var(--muted)", textTransform: "uppercase", letterSpacing: "0.09em", margin: "0 0 8px 2px" }}>
        {title}
      </h3>
      {children}
    </section>
...
export default function ConfiguracionView() {
  ...
  return (
    <div style={{ maxWidth: "480px" }}>
      ...
      {/* ─── Cómo registras tus movimientos ─────────────────────── */}
      ...
      {/* ─── Salidas: Excel, CSV, informe ───────────────────────── */}
      <Section title="Datos e informes">
        <div style={{ background: "var(--white)", border: "1px solid var(--border)", borderRadius: "10px", padding: "20px", marginBottom: "12px" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "6px" }}>
